...
------------------------------ */  
	$('.product-slider').slick({
		...
		slidesToShow: 4,
		slidesToScroll: 1,
		prevArrow: '<button type="button" class="slick-prev"><i class="zmdi zmdi-caret-left-circle"></i></button>',
		nextArrow: '<button type="button" class="slick-next"><i class="zmdi zmdi-caret-right-circle"></i></button>',
		responsive: [
